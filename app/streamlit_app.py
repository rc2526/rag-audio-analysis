...
APP_TITLE = get_str("ui", "app_title", "PMH Group - RAG Analysis Directory")
APP_CAPTION = get_str(
    "ui",
    "app_caption",
...
def render_key() -> None:
    # Previously this showed a long 'How to read this app' expander.
    # Keep the function for callers but render nothing to remove the UI element.
    return
